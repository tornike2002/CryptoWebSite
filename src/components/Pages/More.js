...
const More = () => {
  return (
    <div className="bgg-c">
        <NavBar />
        <section>
            <div className="more-bg-section">
                <div className="more-text_wrapper d-flex align-items-center container">
                    <h1 className="tt-c">Read More</h1>
                </div>
                
            </div>
        </section>
      <div className="more-main_container container d-flex flex-column gap-5">
        <div className="more-layout-wrapper mt-5 ">
          <h1 className="tt-c">General Information</h1>
          <p className="pp-c">
        ...
        <div className="more-layout-wrapper">
          <h1 className="tt-c">
        ...
        <div className="more-layout-wrapper">
          <h1 className="tt-c">Management of Personal Data</h1>
          <p className="pp-c">
        ...
        <div className="more-layout-wrapper">
          <h1 className="tt-c">Information We Collect</h1>
          <p className="pp-c">
        ...
        <div className="more-layout-wrapper">
          <h1 className="tt-c">How We Use Your Information</h1>
          <p className="pp-c">
            ...
            various web site services you use to give you a more seamless,
        ...
        <div className="more-layout-wrapper">
          <h1 className="tt-c">Sharing Your Information</h1>
          <p className="pp-c">
